...
def show_all_users():
    ...
    with open("users.json", "r", encoding= "utf-8") as f:
        ...
        return results #como results es un simil a json es una lista de diccionarios podemos retornarlo por que fastapi puede convertir esto automaticamente a un json
### Show a User
@app.get(
    path= "/users/{user_id}",
    response_model= User,  
